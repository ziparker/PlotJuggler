...
public:
    ...
    virtual void updateState(const PlotDataMapRef& datamap, double current_time) override;
...
private:
    ...
    std::vector<const PlotDataAny *> findRosoutTimeseries(const PlotDataMapRef &datamap);
